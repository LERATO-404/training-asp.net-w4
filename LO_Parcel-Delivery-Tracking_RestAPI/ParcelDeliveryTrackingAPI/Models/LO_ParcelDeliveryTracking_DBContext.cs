...
{
    public partial class LO_ParcelDeliveryTracking_DBContext : DbContext
    {
        public LO_ParcelDeliveryTracking_DBContext()
        {
        }

        public LO_ParcelDeliveryTracking_DBContext(DbContextOptions<LO_ParcelDeliveryTracking_DBContext> options)
            : base(options)
        {
        }
